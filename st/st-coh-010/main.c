...
int main() {
    ...
    if (hartid == 0){
        ...
        *dma_dest_ptr = 0;
        ...
        dma_transfer(DMA_MEM_TO_MEM, (uintptr_t)dma_src_ptr, (uintptr_t)dma_dest_ptr, TRANSFER_SIZE, DWAXIDMAC_AX_CACHE_CACHEABLE, DWAXIDMAC_AX_CACHE_CACHEABLE, dma_test_callback, 0);
    }
